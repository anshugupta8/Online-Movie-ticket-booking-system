...
{//start of method
    try{//start of try
    int l;
System.out.println("                                          **********WELCOME TO JAYA CINEMA**********");
System.out.println("                                          Choose One Of The Following Movies");
System.out.println("                                          ENTER 1.JAI HIND");
...
System.out.println("                                          |LOCATION:JAYA CINEMA            |");
if(r==1)
...
System.out.println("                                          ENTER 1: CLUB-Rs.350 per seat");
System.out.println("                                          ENTER 2: EXECUTIVE-Rs.450 per seat");
int seat;
do{System.out.print("                                          ");
    seat=sc.nextInt();
    if(seat!=1&&seat!=2)
...
sum=u+tax;
    ...
    System.out.println('\u000c');//to clear the terminal window
  ...
  int g=0;int e=0;long mob;
   ...
   if(l==1)
    System.out.println("                                          MOVIE NAME : JAI HIND");
    else if(l==2)
    System.out.println("                                          MOVIE NAME : PREM RATAN DHAN PAYO");
    else
    System.out.println("                                          MOVIE NAME : BAJIRAO MASTAANI");
    System.out.println("                                          INOX : JAYA");
