...
{//start of method
    try{//start of try
    int l;
System.out.println("                                          **********WELCOME TO SWABHUMI CINEMA**********");
System.out.println("                                          Choose One Of The Following Movies");
System.out.println("                                          ENTER 1.BAJRANGI BHAIJAN");
System.out.println("                                          Director:Kabir Khan");
System.out.println("                                          Rating:*****");
System.out.println("                                          Type:ACTION COMEDY");
System.out.println("                                          -------------------------");
System.out.println("                                          ENTER 2.SINGHAM RETURN");
System.out.println("                                          Director:Rohit Shetty");
System.out.println("                                          Rating:****");
System.out.println("                                          Type:ACTION");
System.out.println("                                          -------------------------");
System.out.println("                                          ENTER 3.STUDENT OF THE YEAR");
System.out.println("                                          Director:Karan Johar");
System.out.println("                                          Rating:***");
System.out.println("                                          Type:COMEDY");
System.out.println("                                          -------------------------");
do{System.out.print("                                          ");
   l=sc.nextInt();
   if(l==0 || l>3)
...
System.out.println("                                          |--------------------------------|");
if(l==1)
System.out.println("                                          |MOVIE NAME:BAJRANGI BHAIJAAN    |");
else if(l==2)
System.out.println("                                          |MOVIE NAME:SINGHAM RETURNS      |");
else
System.out.println("                                          |MOVIE NAME:STUDENT OF THE YEAR  |");
System.out.println("                                          |LOCATION:SWABHUMI CINEMA        |");
if(r==1)
    ...
    for(int j=i+1;j<ar1.length;j++)
        {//start of j loop
            ...
            {//start of if
               ...
               do{
                System.out.println("                                          PLEASE ENTER SEAT NUMBER AGAIN");
                System.out.print("                                          ");
                ar1[j]=sc.nextInt();
...
sum=u+tax;
  ...
  int g=0;int e=0;long mob;
   ...
   if(l==1)
    ...
    System.out.println("                                          MOVIE NAME : SINGHAM RETURN");
    else
    System.out.println("                                          MOVIE NAME : STUDENT OF THE YEAR");
    System.out.println("                                          INOX : SHAWBHUMI");
